...
const app = new Vue({
    ...
    methods: {
        ...
        showBasket() {
            basket = document.querySelector('.cart-block')
        ...
        addProduct(product) {
            ...
            if (basket_item) { basket_item.quantity++; }
            else {
                new_item = this.products.find(item => item.id_product === product.id_product);
                new_item.quantity = 1;
                this.basket_products.push(new_item);
            }
        },
